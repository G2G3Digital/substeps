 ...
 * 
 */
@StepImplementations(requiredInitialisationClasses = ExampleSetupAndTearDown.class)
public class ExampleCustomWebdriverStepImplementations {

    /**
     * An example substep implementation
     * 
     * The commented annotations are used to process the javadocs to generate
     * help and content regarding the step implementations used.
     * 
    ...
    public void exampleOne(final String param) {
         ...
         * 
         * Other StepImplementation classes can just be instantiated if you wish
         * to re-use functionality, eg.
         * 
         * final FinderWebDriverSubStepImplementations finder = new
         * FinderWebDriverSubStepImplementations(); finder.findById("some_id");
         * 
         * The Webdriver instance is available via a static method:
         * 
         * com.technophobia.webdriver.substeps.runner.
         * DefaultExecutionSetupTearDown.getThreadLocalWebDriver()
         * 
         * and the WebdriverContext is also available via another static method
         * on the same class:
         * 
         ...
         * 
         * import static com.technophobia.webdriver.substeps.runner.
         * DefaultExecutionSetupTearDown.getThreadLocalWebDriver;
         * 
         */
    }
    ...
    public void exampleTwo(
        ...
        /**
         * Parameters can be conveniently converted to other types, as above.
    ...
    public void exampleThree(final List<Map<String, String>> table) {
        ...
        /**
         * Tables of data can be passed directly from a scenario into a step
         * implementation. Each element in the list represents a row of data,
         * keyed by column name. In the example above
         * 
         * table.get(0).get("col1") would return "row1-1"
         * 
         * NB. At present it is not possible to pass a table of data from a
         * scenario step into a substep.
         */
